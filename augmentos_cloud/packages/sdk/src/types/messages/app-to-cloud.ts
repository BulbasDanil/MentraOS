...
import { ExtendedStreamType, StreamType, LocationStreamRequest } from '../streams';
...
export interface AppSubscriptionUpdate extends BaseMessage {
  ...
  packageName: string;
  subscriptions: SubscriptionRequest[]; // now using our new flexible type
}
...
export type AppToCloudMessage =
  ...
  | AppLocationPollRequest // new poll request added to the message union
  | DisplayRequest
  | PhotoRequest
  | RtmpStreamRequest
